  ...
  return (
    <div className='descriptionBox '>
        ...
        <div className="descriptionbox-description">
            ...
            <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Libero officiis inventore, consequuntur odit ullam reiciendis corporis modi repellat autem facere.</p>
        </div>
